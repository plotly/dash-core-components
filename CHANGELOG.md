...
## [0.22.2] - 2018-05-02
### Fixed
- Bug in `dcc.Checklist`, when values=[] was not put in it, it was showing "Error in Layout". 
This is fixed . See https://github.com/plotly/dash-core-components/pull/191.
