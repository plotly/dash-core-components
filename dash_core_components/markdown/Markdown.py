...
- highlight_config (dict; optional): Config options for syntax highlighting.
...
Legacy from SyntaxHighlighter prop `customStyles`"""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, className=Component.UNDEFINED, containerProps=Component.UNDEFINED, dangerously_allow_html=Component.UNDEFINED, highlight_config=Component.UNDEFINED, loading_state=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'containerProps', 'dangerously_allow_html', 'highlight_config', 'loading_state', 'style']
        self._type = 'Markdown'
        self._namespace = 'dash_core_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'containerProps', 'dangerously_allow_html', 'highlight_config', 'loading_state', 'style']
