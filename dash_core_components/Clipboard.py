...
- title (string; optional):
    ...
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, target_id=Component.UNDEFINED, content=Component.UNDEFINED, n_clicks=Component.UNDEFINED, title=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'className', 'content', 'loading_state', 'n_clicks', 'style', 'target_id', 'title']
        self._type = 'Clipboard'
        self._namespace = 'dash_core_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'content', 'loading_state', 'n_clicks', 'style', 'target_id', 'title']
