...
schema = {'initial_visible_month': {'anyof': [{'type': 'string'}, {'type': 'datetime'}]}, 'reopen_calendar_on_clear': {'type': 'boolean'}, 'disabled': {'type': 'boolean'}, 'setProps': {}, 'id': {'type': 'string'}, 'updatemode': {'type': ('string', 'number'), 'allowed': ['singledate', 'bothdates']}, 'number_of_months_shown': {'type': 'number'}, 'min_date_allowed': {'anyof': [{'type': 'string'}, {'type': 'datetime'}]}, 'max_date_allowed': {'anyof': [{'type': 'string'}, {'type': 'datetime'}]}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['change']}, 'first_day_of_week': {'type': ('string', 'number'), 'allowed': ['0', 0, 0.0, '1', 1, 1.0, '2', 2, 2.0, '3', 3, 3.0, '4', 4, 4.0, '5', 5, 5.0, '6', 6, 6.0]}, 'clearable': {'type': 'boolean'}, 'display_format': {'type': 'string'}, 'start_date': {'anyof': [{'type': 'string'}, {'type': 'datetime'}]}, 'stay_open_on_select': {'type': 'boolean'}, 'end_date': {'anyof': [{'type': 'string'}, {'type': 'datetime'}]}, 'month_format': {'type': 'string'}, 'is_RTL': {'type': 'boolean'}, 'show_outside_days': {'type': 'boolean'}, 'calendar_orientation': {'type': ('string', 'number'), 'allowed': ['vertical', 'horizontal']}, 'with_full_screen_portal': {'type': 'boolean'}, 'fireEvent': {}, 'with_portal': {'type': 'boolean'}, 'minimum_nights': {'type': 'number'}, 'day_size': {'type': 'number'}, 'start_date_placeholder_text': {'type': 'string'}, 'end_date_placeholder_text': {'type': 'string'}}
