...
schema = {'initial_visible_month': {'type': 'string'}, 'show_outside_days': {'type': 'boolean'}, 'first_day_of_week': {'type': ('string', 'number'), 'allowed': ['0', '1', '2', '3', '4', '5', '6']}, 'reopen_calendar_on_clear': {'type': 'boolean'}, 'display_format': {'type': 'string'}, 'is_RTL': {'type': 'boolean'}, 'clearable': {'type': 'boolean'}, 'max_date_allowed': {'type': 'string'}, 'stay_open_on_select': {'type': 'boolean'}, 'id': {'type': 'string'}, 'with_full_screen_portal': {'type': 'boolean'}, 'start_date_placeholder_text': {'type': 'string'}, 'setProps': {}, 'calendar_orientation': {'type': ('string', 'number'), 'allowed': ['vertical', 'horizontal']}, 'start_date': {'type': 'string'}, 'min_date_allowed': {'type': 'string'}, 'with_portal': {'type': 'boolean'}, 'number_of_months_shown': {'type': 'number'}, 'end_date_placeholder_text': {'type': 'string'}, 'month_format': {'type': 'string'}, 'end_date': {'type': 'string'}, 'minimum_nights': {'type': 'number'}, 'day_size': {'type': 'number'}, 'updatemode': {'type': ('string', 'number'), 'allowed': ['singledate', 'bothdates']}, 'disabled': {'type': 'boolean'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['change']}}
