...
schema = {'hidden': {'type': 'string'}, 'accessKey': {'type': 'string'}, 'lang': {'type': 'string'}, 'rows': {'type': 'string'}, 'style': {'type': 'dict'}, 'draggable': {'type': 'string'}, 'contentEditable': {'type': 'string'}, 'required': {'type': 'string'}, 'minLength': {'type': 'string'}, 'className': {'type': 'string'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['click', 'blur', 'change']}, 'contextMenu': {'type': 'string'}, 'setProps': {}, 'readOnly': {'type': 'string'}, 'placeholder': {'type': 'string'}, 'dir': {'type': 'string'}, 'name': {'type': 'string'}, 'fireEvent': {}, 'id': {'type': 'string'}, 'title': {'type': 'string'}, 'form': {'type': 'string'}, 'maxLength': {'type': 'string'}, 'tabIndex': {'type': 'string'}, 'value': {'type': 'string'}, 'wrap': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'cols': {'type': 'string'}, 'autoFocus': {'type': 'string'}, 'disabled': {'type': 'string'}}
