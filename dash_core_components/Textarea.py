...
schema = {'contentEditable': {'type': 'string'}, 'cols': {'type': 'string'}, 'disabled': {'type': 'string'}, 'wrap': {'type': 'string'}, 'setProps': {}, 'id': {'type': 'string'}, 'tabIndex': {'type': 'string'}, 'draggable': {'type': 'string'}, 'style': {'type': 'dict'}, 'rows': {'type': 'string'}, 'title': {'type': 'string'}, 'accessKey': {'type': 'string'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['click', 'blur', 'change']}, 'hidden': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'form': {'type': 'string'}, 'contextMenu': {'type': 'string'}, 'minLength': {'type': 'string'}, 'readOnly': {'type': 'string'}, 'maxLength': {'type': 'string'}, 'autoFocus': {'type': 'string'}, 'placeholder': {'type': 'string'}, 'fireEvent': {}, 'lang': {'type': 'string'}, 'name': {'type': 'string'}, 'required': {'type': 'string'}, 'value': {'type': 'string'}, 'className': {'type': 'string'}, 'dir': {'type': 'string'}}
