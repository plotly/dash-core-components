...
schema = {'id': {'type': 'string'}, 'value': {'type': 'string'}, 'autoFocus': {'type': 'string'}, 'cols': {'type': 'string'}, 'disabled': {'type': 'string'}, 'form': {'type': 'string'}, 'maxLength': {'type': 'string'}, 'minLength': {'type': 'string'}, 'name': {'type': 'string'}, 'placeholder': {'type': 'string'}, 'readOnly': {'type': 'string'}, 'required': {'type': 'string'}, 'rows': {'type': 'string'}, 'wrap': {'type': 'string'}, 'accessKey': {'type': 'string'}, 'className': {'type': 'string'}, 'contentEditable': {'type': 'string'}, 'contextMenu': {'type': 'string'}, 'dir': {'type': 'string'}, 'draggable': {'type': 'string'}, 'hidden': {'type': 'string'}, 'lang': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'style': {'type': 'dict'}, 'tabIndex': {'type': 'string'}, 'title': {'type': 'string'}, 'setProps': {}, 'fireEvent': {}, 'dashEvents': {'allowed': ['click', 'blur', 'change'], 'type': ('string', 'number')}}
