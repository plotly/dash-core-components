...
schema = {'initial_visible_month': {'type': 'string'}, 'show_outside_days': {'type': 'boolean'}, 'first_day_of_week': {'type': ('string', 'number'), 'allowed': ['0', '1', '2', '3', '4', '5', '6']}, 'reopen_calendar_on_clear': {'type': 'boolean'}, 'display_format': {'type': 'string'}, 'max_date_allowed': {'type': 'string'}, 'is_RTL': {'type': 'boolean'}, 'stay_open_on_select': {'type': 'boolean'}, 'id': {'type': 'string'}, 'with_full_screen_portal': {'type': 'boolean'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['change']}, 'date': {'type': 'string'}, 'setProps': {}, 'placeholder': {'type': 'string'}, 'calendar_orientation': {'type': ('string', 'number'), 'allowed': ['vertical', 'horizontal']}, 'min_date_allowed': {'type': 'string'}, 'with_portal': {'type': 'boolean'}, 'number_of_months_shown': {'type': 'number'}, 'clearable': {'type': 'boolean'}, 'day_size': {'type': 'number'}, 'month_format': {'type': 'string'}, 'disabled': {'type': 'boolean'}}
