...
schema = {'initial_visible_month': {'anyof': [{'type': 'string'}, {'type': 'datetime'}]}, 'reopen_calendar_on_clear': {'type': 'boolean'}, 'disabled': {'type': 'boolean'}, 'setProps': {}, 'id': {'type': 'string'}, 'number_of_months_shown': {'type': 'number'}, 'min_date_allowed': {'anyof': [{'type': 'string'}, {'type': 'datetime'}]}, 'max_date_allowed': {'anyof': [{'type': 'string'}, {'type': 'datetime'}]}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['change']}, 'first_day_of_week': {'type': ('string', 'number'), 'allowed': ['0', 0, 0.0, '1', 1, 1.0, '2', 2, 2.0, '3', 3, 3.0, '4', 4, 4.0, '5', 5, 5.0, '6', 6, 6.0]}, 'clearable': {'type': 'boolean'}, 'display_format': {'type': 'string'}, 'stay_open_on_select': {'type': 'boolean'}, 'month_format': {'type': 'string'}, 'is_RTL': {'type': 'boolean'}, 'show_outside_days': {'type': 'boolean'}, 'calendar_orientation': {'type': ('string', 'number'), 'allowed': ['vertical', 'horizontal']}, 'date': {'anyof': [{'type': 'string'}, {'type': 'datetime'}]}, 'with_full_screen_portal': {'type': 'boolean'}, 'placeholder': {'type': 'string'}, 'fireEvent': {}, 'with_portal': {'type': 'boolean'}, 'day_size': {'type': 'number'}}
