...
schema = {'disabled': {'type': 'boolean'}, 'selectionStart': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'selectionEnd': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'setProps': {}, 'id': {'type': 'string'}, 'size': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'className': {'type': 'string'}, 'style': {'type': 'dict'}, 'spellcheck': {'type': 'string'}, 'min': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'minlength': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['blur', 'change']}, 'readonly': {'type': 'string'}, 'autofocus': {'type': 'string'}, 'type': {'type': ('string', 'number'), 'allowed': ['text', 'number', 'password', 'email', 'range', 'search', 'tel', 'url', 'hidden']}, 'multiple': {'type': 'string'}, 'max': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'maxlength': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'step': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'selectionDirection': {'type': 'string'}, 'placeholder': {'type': 'string'}, 'fireEvent': {}, 'name': {'type': 'string'}, 'required': {'type': 'string'}, 'list': {'type': 'string'}, 'value': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'autocomplete': {'type': 'string'}, 'inputmode': {'type': ('string', 'number'), 'allowed': ['verbatim', 'latin', 'latin-name', 'latin-prose', 'full-width-latin', 'kana', 'katakana', 'numeric', 'tel', 'email', 'url']}, 'pattern': {'type': 'string'}}
