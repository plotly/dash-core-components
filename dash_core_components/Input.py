...
schema = {'minlength': {'type': 'string'}, 'type': {'type': ('string', 'number'), 'allowed': ['text', 'number', 'password', 'email', 'range', 'search', 'tel', 'url', 'hidden']}, 'selectionStart': {'type': 'string'}, 'multiple': {'type': 'string'}, 'selectionDirection': {'type': 'string'}, 'list': {'type': 'string'}, 'className': {'type': 'string'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['blur', 'change']}, 'setProps': {}, 'placeholder': {'type': 'string'}, 'selectionEnd': {'type': 'string'}, 'min': {'type': 'string'}, 'name': {'type': 'string'}, 'fireEvent': {}, 'id': {'type': 'string'}, 'autocomplete': {'type': 'string'}, 'step': {'type': 'string'}, 'max': {'type': 'string'}, 'autofocus': {'type': 'string'}, 'size': {'type': 'string'}, 'value': {'type': 'string'}, 'maxlength': {'type': 'string'}, 'pattern': {'type': 'string'}, 'inputmode': {'type': ('string', 'number'), 'allowed': ['verbatim', 'latin', 'latin-name', 'latin-prose', 'full-width-latin', 'kana', 'katakana', 'numeric', 'tel', 'email', 'url']}, 'spellcheck': {'type': 'string'}, 'style': {'type': 'dict'}, 'readonly': {'type': 'string'}, 'disabled': {'type': 'boolean'}, 'required': {'type': 'string'}}
