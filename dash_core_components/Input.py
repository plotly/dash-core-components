...
schema = {'disabled': {'required': False, 'type': 'boolean', 'nullable': False}, 'selectionStart': {'required': False, 'anyof': [{'type': 'string'}, {'type': 'number'}], 'nullable': False}, 'selectionEnd': {'required': False, 'anyof': [{'type': 'string'}, {'type': 'number'}], 'nullable': False}, 'setProps': {'required': False, 'nullable': False}, 'id': {'required': False, 'type': 'string', 'nullable': False}, 'size': {'required': False, 'anyof': [{'type': 'string'}, {'type': 'number'}], 'nullable': False}, 'className': {'required': False, 'type': 'string', 'nullable': False}, 'style': {'required': False, 'type': 'dict', 'nullable': False}, 'spellcheck': {'required': False, 'type': 'string', 'nullable': False}, 'min': {'required': False, 'anyof': [{'type': 'string'}, {'type': 'number'}], 'nullable': False}, 'minlength': {'required': False, 'anyof': [{'type': 'string'}, {'type': 'number'}], 'nullable': False}, 'dashEvents': {'required': False, 'nullable': False, 'type': ('string', 'number'), 'allowed': ['blur', 'change']}, 'readonly': {'required': False, 'type': 'string', 'nullable': False}, 'autofocus': {'required': False, 'type': 'string', 'nullable': False}, 'type': {'required': False, 'nullable': False, 'type': ('string', 'number'), 'allowed': ['text', 'number', 'password', 'email', 'range', 'search', 'tel', 'url', 'hidden']}, 'multiple': {'required': False, 'type': 'string', 'nullable': False}, 'max': {'required': False, 'anyof': [{'type': 'string'}, {'type': 'number'}], 'nullable': False}, 'maxlength': {'required': False, 'anyof': [{'type': 'string'}, {'type': 'number'}], 'nullable': False}, 'step': {'required': False, 'anyof': [{'type': 'string'}, {'type': 'number'}], 'nullable': False}, 'selectionDirection': {'required': False, 'type': 'string', 'nullable': False}, 'placeholder': {'required': False, 'type': 'string', 'nullable': False}, 'fireEvent': {'required': False, 'nullable': False}, 'name': {'required': False, 'type': 'string', 'nullable': False}, 'required': {'required': False, 'type': 'string', 'nullable': False}, 'list': {'required': False, 'type': 'string', 'nullable': False}, 'value': {'required': False, 'anyof': [{'type': 'string'}, {'type': 'number'}], 'nullable': False}, 'autocomplete': {'required': False, 'type': 'string', 'nullable': False}, 'inputmode': {'required': False, 'nullable': False, 'type': ('string', 'number'), 'allowed': ['verbatim', 'latin', 'latin-name', 'latin-prose', 'full-width-latin', 'kana', 'katakana', 'numeric', 'tel', 'email', 'url']}, 'pattern': {'required': False, 'type': 'string', 'nullable': False}}
...
- selectionEnd (string | number; optional): The offset into the element's text content of the last selected character. If there's no selection, this value indicates the offset to the character following the current text input cursor position (that is, the position the next character typed would occupy).
- selectionStart (string | number; optional): The offset into the element's text content of the first selected character. If there's no selection, this value indicates the offset to the character following the current text input cursor position (that is, the position the next character typed would occupy).
- size (string | number; optional): The initial size of the control. This value is in pixels unless the value of the type attribute is text or password, in which case it is an integer number of characters. Starting in, this attribute applies only when the type attribute is set to text, search, tel, url, email, or password, otherwise it is ignored. In addition, the size must be greater than zero. If you do not specify a size, a default value of 20 is used.' simply states "the user agent should ensure that at least that many characters are visible", but different characters can have different widths in certain fonts. In some browsers, a certain string with x characters will not be entirely visible even if size is defined to at least x.
