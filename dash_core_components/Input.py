...
schema = {'id': {'type': 'string'}, 'value': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'style': {'type': 'dict'}, 'className': {'type': 'string'}, 'type': {'allowed': ['text', 'number', 'password', 'email', 'range', 'search', 'tel', 'url', 'hidden'], 'type': ('string', 'number')}, 'autocomplete': {'type': 'string'}, 'autofocus': {'type': 'string'}, 'disabled': {'type': 'boolean'}, 'inputmode': {'allowed': ['verbatim', 'latin', 'latin-name', 'latin-prose', 'full-width-latin', 'kana', 'katakana', 'numeric', 'tel', 'email', 'url'], 'type': ('string', 'number')}, 'list': {'type': 'string'}, 'max': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'maxlength': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'min': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'minlength': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'multiple': {'type': 'string'}, 'name': {'type': 'string'}, 'pattern': {'type': 'string'}, 'placeholder': {'type': 'string'}, 'readonly': {'type': 'string'}, 'required': {'type': 'string'}, 'selectionDirection': {'type': 'string'}, 'selectionEnd': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'selectionStart': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'size': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'spellcheck': {'type': 'string'}, 'step': {'anyof': [{'type': 'string'}, {'type': 'number'}]}, 'fireEvent': {}, 'setProps': {}, 'dashEvents': {'allowed': ['blur', 'change'], 'type': ('string', 'number')}}
