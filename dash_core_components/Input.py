...
schema = {'id': {'type': 'string'}, 'value': {'type': 'string'}, 'style': {'type': 'dict'}, 'className': {'type': 'string'}, 'type': {'allowed': ['text', 'number', 'password', 'email', 'range', 'search', 'tel', 'url', 'hidden'], 'type': ('string', 'number')}, 'autocomplete': {'type': 'string'}, 'autofocus': {'type': 'string'}, 'disabled': {'type': 'boolean'}, 'inputmode': {'allowed': ['verbatim', 'latin', 'latin-name', 'latin-prose', 'full-width-latin', 'kana', 'katakana', 'numeric', 'tel', 'email', 'url'], 'type': ('string', 'number')}, 'list': {'type': 'string'}, 'max': {'type': 'string'}, 'maxlength': {'type': 'string'}, 'min': {'type': 'string'}, 'minlength': {'type': 'string'}, 'multiple': {'type': 'string'}, 'name': {'type': 'string'}, 'pattern': {'type': 'string'}, 'placeholder': {'type': 'string'}, 'readonly': {'type': 'string'}, 'required': {'type': 'string'}, 'selectionDirection': {'type': 'string'}, 'selectionEnd': {'type': 'string'}, 'selectionStart': {'type': 'string'}, 'size': {'type': 'string'}, 'spellcheck': {'type': 'string'}, 'step': {'type': 'string'}, 'fireEvent': {}, 'setProps': {}, 'dashEvents': {'allowed': ['blur', 'change'], 'type': ('string', 'number')}}
