...
schema = {'selectedData': {'nullable': True, 'type': 'dict'}, 'clickData': {'nullable': True, 'type': 'dict'}, 'relayoutData': {'nullable': True, 'type': 'dict'}, 'className': {'nullable': True, 'type': 'string'}, 'dashEvents': {'nullable': True, 'allowed': [None, 'click', 'hover', 'selected', 'relayout', 'unhover']}, 'animation_options': {'nullable': True, 'type': 'dict'}, 'hoverData': {'nullable': True, 'type': 'dict'}, 'style': {'nullable': True, 'type': 'dict'}, 'figure': {'nullable': True, 'validator': 'plotly_figure'}, 'id': {'required': True, 'nullable': True, 'type': 'string'}, 'clear_on_unhover': {'nullable': True, 'type': 'boolean'}, 'setProps': {'nullable': True}, 'config': {'schema': {'doubleClick': {'nullable': True, 'allowed': [None, 'false', 'reset', 'autosize', 'reset+autosize']}, 'autosizable': {'nullable': True, 'type': 'boolean'}, 'staticPlot': {'nullable': True, 'type': 'boolean'}, 'displayModeBar': {'nullable': True, 'allowed': [None, 'true', 'false', 'hover']}, 'sendData': {'nullable': True, 'type': 'boolean'}, 'fillFrame': {'nullable': True, 'type': 'boolean'}, 'modeBarButtonsToRemove': {'nullable': True, 'type': 'list'}, 'modeBarButtons': {'nullable': True, 'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'showLink': {'nullable': True, 'type': 'boolean'}, 'edits': {'schema': {'legendText': {'nullable': True, 'type': 'boolean'}, 'annotationTail': {'nullable': True, 'type': 'boolean'}, 'legendPosition': {'nullable': True, 'type': 'boolean'}, 'colorbarPosition': {'nullable': True, 'type': 'boolean'}, 'annotationText': {'nullable': True, 'type': 'boolean'}, 'annotationPosition': {'nullable': True, 'type': 'boolean'}, 'colorbarTitleText': {'nullable': True, 'type': 'boolean'}, 'axisTitleText': {'nullable': True, 'type': 'boolean'}, 'shapePosition': {'nullable': True, 'type': 'boolean'}, 'titleText': {'nullable': True, 'type': 'boolean'}}, 'allow_unknown': False, 'nullable': True, 'type': 'dict'}, 'showAxisDragHandles': {'nullable': True, 'type': 'boolean'}, 'displaylogo': {'nullable': True, 'type': 'boolean'}, 'editable': {'nullable': True, 'type': 'boolean'}, 'plotGlPixelRatio': {'nullable': True, 'type': 'number'}, 'scrollZoom': {'nullable': True, 'type': 'boolean'}, 'queueLength': {'nullable': True, 'type': 'number'}, 'showAxisRangeEntryBoxes': {'nullable': True, 'type': 'boolean'}, 'frameMargins': {'nullable': True, 'type': 'number'}, 'topojsonURL': {'nullable': True, 'type': 'string'}, 'modeBarButtonsToAdd': {'nullable': True, 'type': 'list'}, 'linkText': {'nullable': True, 'type': 'string'}, 'showTips': {'nullable': True, 'type': 'boolean'}, 'mapboxAccessToken': {'nullable': True, 'type': ('boolean', 'number', 'string', 'dict', 'list')}}, 'nullable': True, 'type': 'dict', 'allow_unknown': False}, 'fireEvent': {'nullable': True}, 'animate': {'nullable': True, 'type': 'boolean'}}
