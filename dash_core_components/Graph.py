...
schema = {'style': {'type': 'dict'}, 'figure': {'type': 'dict'}, 'config': {'nullable': False, 'type': 'dict', 'allow_unknown': False, 'schema': {'topojsonURL': {'type': 'string'}, 'fillFrame': {'type': 'boolean'}, 'displayModeBar': {'type': ('string', 'number'), 'allowed': [True, False, 'hover']}, 'autosizable': {'type': 'boolean'}, 'doubleClick': {'type': ('string', 'number'), 'allowed': [False, 'reset', 'autosize', 'reset+autosize']}, 'sendData': {'type': 'boolean'}, 'queueLength': {'type': 'number'}, 'displaylogo': {'type': 'boolean'}, 'edits': {'schema': {'colorbarPosition': {'type': 'boolean'}, 'annotationPosition': {'type': 'boolean'}, 'shapePosition': {'type': 'boolean'}, 'annotationText': {'type': 'boolean'}, 'titleText': {'type': 'boolean'}, 'legendPosition': {'type': 'boolean'}, 'legendText': {'type': 'boolean'}, 'annotationTail': {'type': 'boolean'}, 'colorbarTitleText': {'type': 'boolean'}, 'axisTitleText': {'type': 'boolean'}}, 'type': 'dict', 'allow_unknown': False, 'nullable': False}, 'showLink': {'type': 'boolean'}, 'showAxisDragHandles': {'type': 'boolean'}, 'modeBarButtons': {'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'scrollZoom': {'type': 'boolean'}, 'editable': {'type': 'boolean'}, 'linkText': {'type': 'string'}, 'staticPlot': {'type': 'boolean'}, 'showTips': {'type': 'boolean'}, 'mapboxAccessToken': {'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'frameMargins': {'type': 'number'}, 'plotGlPixelRatio': {'type': 'number'}, 'modeBarButtonsToRemove': {'type': 'list'}, 'modeBarButtonsToAdd': {'type': 'list'}, 'showAxisRangeEntryBoxes': {'type': 'boolean'}}}, 'setProps': {}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['click', 'hover', 'selected', 'relayout', 'unhover']}, 'fireEvent': {}, 'className': {'type': 'string'}, 'clear_on_unhover': {'type': 'boolean'}, 'relayoutData': {'type': 'dict'}, 'clickData': {'type': 'dict'}, 'animate': {'type': 'boolean'}, 'hoverData': {'type': 'dict'}, 'animation_options': {'type': 'dict'}, 'id': {'type': 'string'}, 'selectedData': {'type': 'dict'}}
