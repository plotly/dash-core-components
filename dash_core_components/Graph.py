...
schema = {'selectedData': {'type': 'dict'}, 'figure': {'type': 'dict'}, 'hoverData': {'type': 'dict'}, 'animation_options': {'type': 'dict'}, 'clickData': {'type': 'dict'}, 'id': {'type': 'string', 'required': True}, 'config': {'type': 'dict', 'nullable': False, 'allow_unknown': False, 'schema': {'modeBarButtonsToAdd': {'type': 'list'}, 'mapboxAccessToken': {'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'showAxisRangeEntryBoxes': {'type': 'boolean'}, 'staticPlot': {'type': 'boolean'}, 'doubleClick': {'type': ('string', 'number'), 'allowed': ['false', 'reset', 'autosize', 'reset+autosize']}, 'showLink': {'type': 'boolean'}, 'plotGlPixelRatio': {'type': 'number'}, 'editable': {'type': 'boolean'}, 'modeBarButtons': {'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'showTips': {'type': 'boolean'}, 'frameMargins': {'type': 'number'}, 'edits': {'type': 'dict', 'nullable': False, 'allow_unknown': False, 'schema': {'legendPosition': {'type': 'boolean'}, 'titleText': {'type': 'boolean'}, 'colorbarPosition': {'type': 'boolean'}, 'shapePosition': {'type': 'boolean'}, 'axisTitleText': {'type': 'boolean'}, 'legendText': {'type': 'boolean'}, 'annotationTail': {'type': 'boolean'}, 'colorbarTitleText': {'type': 'boolean'}, 'annotationText': {'type': 'boolean'}, 'annotationPosition': {'type': 'boolean'}}}, 'fillFrame': {'type': 'boolean'}, 'autosizable': {'type': 'boolean'}, 'scrollZoom': {'type': 'boolean'}, 'linkText': {'type': 'string'}, 'topojsonURL': {'type': 'string'}, 'displaylogo': {'type': 'boolean'}, 'queueLength': {'type': 'number'}, 'modeBarButtonsToRemove': {'type': 'list'}, 'showAxisDragHandles': {'type': 'boolean'}, 'displayModeBar': {'type': ('string', 'number'), 'allowed': ['true', 'false', 'hover']}, 'sendData': {'type': 'boolean'}}}, 'className': {'type': 'string'}, 'animate': {'type': 'boolean'}, 'fireEvent': {}, 'setProps': {}, 'style': {'type': 'dict'}, 'relayoutData': {'type': 'dict'}, 'clear_on_unhover': {'type': 'boolean'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['click', 'hover', 'selected', 'relayout', 'unhover']}}
