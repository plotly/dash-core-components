...
- in_progress (boolean; optional):
    If True, the spinner will remain in the loading state until set to
    False.
...
- type (a value equal to: 'graph', 'cube', 'circle', 'dot', 'default'; default 'default'):
    ...
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, type=Component.UNDEFINED, fullscreen=Component.UNDEFINED, debug=Component.UNDEFINED, in_progress=Component.UNDEFINED, className=Component.UNDEFINED, parent_className=Component.UNDEFINED, style=Component.UNDEFINED, parent_style=Component.UNDEFINED, color=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'color', 'debug', 'fullscreen', 'in_progress', 'loading_state', 'parent_className', 'parent_style', 'style', 'type']
        self._type = 'Loading'
        self._namespace = 'dash_core_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'color', 'debug', 'fullscreen', 'in_progress', 'loading_state', 'parent_className', 'parent_style', 'style', 'type']
