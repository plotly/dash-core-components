...
schema = {'style_reject': {'type': 'dict'}, 'min_size': {'type': 'number'}, 'style': {'type': 'dict'}, 'multiple': {'type': 'boolean'}, 'style_disabled': {'type': 'dict'}, 'className_reject': {'type': 'string'}, 'className_disabled': {'type': 'string'}, 'accept': {'type': 'string'}, 'id': {'type': 'string'}, 'disabled': {'type': 'boolean'}, 'className': {'type': 'string'}, 'last_modified': {'anyof': [{'type': 'number'}, {'type': 'list', 'schema': {'type': 'number', 'nullable': False}}]}, 'style_active': {'type': 'dict'}, 'max_size': {'type': 'number'}, 'className_active': {'type': 'string'}, 'filename': {'anyof': [{'type': 'string'}, {'type': 'list', 'schema': {'type': 'string', 'nullable': False}}]}, 'disable_click': {'type': 'boolean'}, 'children': {'anyof': [{'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}, {'type': 'list', 'schema': {'type': ('component', 'boolean', 'number', 'string')}}]}, {'type': 'string'}, {'nullable': True, 'type': ('string', 'number'), 'allowed': [None]}], 'nullable': True}, 'contents': {'anyof': [{'type': 'string'}, {'type': 'list', 'schema': {'type': 'string', 'nullable': False}}]}, 'setProps': {}}
