...
schema = {'count': {'type': 'number'}, 'disabled': {'type': 'boolean'}, 'updatemode': {'type': ('string', 'number'), 'allowed': ['mouseup', 'drag']}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['change']}, 'vertical': {'type': 'boolean'}, 'min': {'type': 'number'}, 'max': {'type': 'number'}, 'step': {'type': 'number'}, 'value': {'type': 'list', 'schema': {'type': 'number', 'nullable': False}}, 'fireEvent': {}, 'className': {'type': 'string'}, 'dots': {'type': 'boolean'}, 'marks': {'type': 'dict', 'valueschema': {'anyof': [{'type': 'string'}, {'schema': {'style': {'type': 'dict'}, 'label': {'type': 'string'}}, 'type': 'dict', 'allow_unknown': False, 'nullable': False}]}, 'nullable': False}, 'included': {'type': 'boolean'}, 'setProps': {}, 'pushable': {'anyof': [{'type': 'boolean'}, {'type': 'number'}]}, 'id': {'type': 'string'}, 'allowCross': {'type': 'boolean'}}
