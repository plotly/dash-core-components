...
schema = {'fireEvent': {}, 'dots': {'type': 'boolean'}, 'allowCross': {'type': 'boolean'}, 'step': {'type': 'number'}, 'max': {'type': 'number'}, 'vertical': {'type': 'boolean'}, 'dashEvents': {'type': ('string', 'number'), 'allowed': ['change']}, 'pushable': {'anyof': [{'type': 'boolean'}, {'type': 'number'}]}, 'id': {'type': 'string'}, 'value': {'type': 'list', 'schema': {'type': 'number', 'nullable': False}}, 'className': {'type': 'string'}, 'disabled': {'type': 'boolean'}, 'updatemode': {'type': ('string', 'number'), 'allowed': ['mouseup', 'drag']}, 'setProps': {}, 'included': {'type': 'boolean'}, 'count': {'type': 'number'}, 'min': {'type': 'number'}, 'marks': {'type': 'dict', 'nullable': False, 'allow_unknown': False, 'schema': {'number': {'anyof': [{'type': 'string'}, {'type': 'dict', 'nullable': False, 'allow_unknown': False, 'schema': {'label': {'type': 'string'}, 'style': {'type': 'dict'}}}]}}}}
