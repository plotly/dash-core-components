...
schema = {'dots': {'required': False, 'type': 'boolean', 'nullable': False}, 'disabled': {'required': False, 'type': 'boolean', 'nullable': False}, 'updatemode': {'required': False, 'nullable': False, 'type': ('string', 'number'), 'allowed': ['mouseup', 'drag']}, 'vertical': {'required': False, 'type': 'boolean', 'nullable': False}, 'min': {'required': False, 'type': 'number', 'nullable': False}, 'max': {'required': False, 'type': 'number', 'nullable': False}, 'dashEvents': {'required': False, 'nullable': False, 'type': ('string', 'number'), 'allowed': ['change']}, 'value': {'required': False, 'type': 'number', 'nullable': False}, 'fireEvent': {'required': False, 'nullable': False}, 'className': {'required': False, 'type': 'string', 'nullable': False}, 'step': {'required': False, 'type': 'number', 'nullable': False}, 'marks': {'required': False, 'type': 'dict', 'valueschema': {'anyof': [{'type': 'string'}, {'schema': {'style': {'type': 'dict'}, 'label': {'type': 'string'}}, 'type': 'dict', 'allow_unknown': False, 'nullable': False}]}, 'nullable': False}, 'included': {'required': False, 'type': 'boolean', 'nullable': False}, 'setProps': {'required': False, 'nullable': False}, 'id': {'required': False, 'type': 'string', 'nullable': False}}
