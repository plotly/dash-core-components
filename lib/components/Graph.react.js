...
var PlotlyGraph = /*#__PURE__*/function (_Component) {
  ...
  _createClass(PlotlyGraph, [{
    ...
    key: "clearState",
    value: function clearState(dataKey) {
      this.setState(function (props) {
        var data = props[dataKey];
        var res = data && data.length ? _defineProperty({}, dataKey, EMPTY_DATA) : undefined;
        return res;
      });
    }
  }, {
    ...
    value: function render() {
      return /*#__PURE__*/_react.default.createElement(ControlledPlotlyGraph, _extends({}, this.props, {
...
var ControlledPlotlyGraph = /*#__PURE__*/(0, _react.memo)(function (props) {
  ...
  }, /*#__PURE__*/_react.default.createElement(RealPlotlyGraph, _extends({}, props, {
