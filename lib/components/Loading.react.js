  ...
  _createClass(Loading, [{
    ...
    value: function render() {
      ...
      if (loading_state && loading_state.is_loading) {
        var Spinner = getSpinner(spinnerType);
        return _react.default.createElement(Spinner, {
          className: className,
          style: style,
      ...
      if ((0, _ramda.type)(this.props.children) !== 'Object' || (0, _ramda.type)(this.props.children) !== 'Function') {
