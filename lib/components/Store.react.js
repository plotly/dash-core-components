...
function dataChanged(newData, oldData) {
  var oldNull = (0, _ramda.isNil)(oldData);
  var newNull = (0, _ramda.isNil)(newData);

  if (oldNull || newNull) {
    return newData !== oldData;
  }

  var newType = (0, _ramda.type)(newData);

  if (newType !== (0, _ramda.type)(oldData)) {
    return true;
  }
  ...
  if (newType === 'Array') {
  ...
  } else if ((0, _ramda.includes)(newType, ['String', 'Number', 'Boolean'])) {
    ...
    return (0, _ramda.any)(function (_ref) {
