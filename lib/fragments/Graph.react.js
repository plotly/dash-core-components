...
function (_Component) {
  ...
  _createClass(PlotlyGraph, [{
    ...
    value: function componentDidMount() {
      ...
      if (((_this$props$prependDa = this.props.prependData) === null || _this$props$prependDa === void 0 ? void 0 : _this$props$prependDa.length) || ((_this$props$extendDat = this.props.extendData) === null || _this$props$extendDat === void 0 ? void 0 : _this$props$extendDat.length)) {
    ...
    value: function UNSAFE_componentWillReceiveProps(nextProps) {
      ...
      if (((_this$props$prependDa2 = this.props.prependData) === null || _this$props$prependDa2 === void 0 ? void 0 : _this$props$prependDa2.length) || ((_this$props$extendDat2 = this.props.extendData) === null || _this$props$extendDat2 === void 0 ? void 0 : _this$props$extendDat2.length)) {
        this.props._dashprivate_onFigureModified(this.props.figure);
      }
    }
  }, {
