...
var _convertToMoment4 = _interopRequireDefault(require("../utils/convertToMoment"));
...
var DatePickerRange = /*#__PURE__*/function (_Component) {
  ...
  _createClass(DatePickerRange, [{
    ...
    value: function onDatesChange(_ref) {
      ...
      var oldMomentDates = (0, _convertToMoment4.default)(this.state, ['start_date', 'end_date']);
    ...
    value: function isOutsideRange(date) {
      var _convertToMoment = (0, _convertToMoment4.default)(this.props, ['max_date_allowed', 'min_date_allowed', 'disabled_days']),
    ...
    value: function render() {
      ...
      var _convertToMoment2 = (0, _convertToMoment4.default)(this.props, ['initial_visible_month']),
          initial_visible_month = _convertToMoment2.initial_visible_month;

      var _convertToMoment3 = (0, _convertToMoment4.default)(this.state, ['start_date', 'end_date']),
          start_date = _convertToMoment3.start_date,
          end_date = _convertToMoment3.end_date;
