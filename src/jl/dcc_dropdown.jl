...
an optional disabled field can be used for each option. options has the following type: Array of lists containing elements 'label', 'value', 'disabled', 'title'.
Those elements have the following types:
...
function dcc_dropdown(; kwargs...)
        available_props = Symbol[:id, :className, :clearable, :disabled, :loading_state, :multi, :optionHeight, :options, :persisted_props, :persistence, :persistence_type, :placeholder, :search_value, :searchable, :style, :value]
        wild_props = Symbol[]
