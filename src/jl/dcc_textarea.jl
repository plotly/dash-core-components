...
function dcc_textarea(; kwargs...)
        available_props = Symbol[:id, :accessKey, :autoFocus, :className, :cols, :contentEditable, :contextMenu, :dir, :disabled, :draggable, :form, :hidden, :lang, :loading_state, :maxLength, :minLength, :n_blur, :n_blur_timestamp, :n_clicks, :n_clicks_timestamp, :name, :persisted_props, :persistence, :persistence_type, :placeholder, :readOnly, :required, :rows, :spellCheck, :style, :tabIndex, :title, :value, :wrap]
        wild_props = Symbol[]
        return Component("dcc_textarea", "Textarea", "dash_core_components", available_props, wild_props; kwargs...)
end
