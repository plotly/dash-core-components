...
function dcc_rangeslider(; kwargs...)
        available_props = Symbol[:id, :allowCross, :className, :count, :disabled, :dots, :drag_value, :included, :loading_state, :marks, :max, :min, :persisted_props, :persistence, :persistence_type, :pushable, :step, :tooltip, :updatemode, :value, :vertical, :verticalHeight]
        wild_props = Symbol[]
        return Component("dcc_rangeslider", "RangeSlider", "dash_core_components", available_props, wild_props; kwargs...)
end
