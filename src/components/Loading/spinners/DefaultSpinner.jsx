    ...
    return (
        <div>
            ...
            <div className="dash-spinner">
                <div className="dash-spinner-title">
                    <p>Loading...</p>
                </div>
            ...
            <style>
                {`
                      ...
                      .dash-spinner-title {
                        position: absolute;
                        width: 100%;
                        font-family: 'Ubuntu',-apple-system,BlinkMacSystemFont,Roboto,"Helvetica Neue",Arial,sans-serif;
                        font-weight: 600;
                      }
                      .dash-spinner-title p{
                        text-align: center;
                        font-weight: 100;
                        animation: dash-title 2s infinite;
                      }
                      .dash-spinner {
                        display: flex;
                        margin: 0 auto;
