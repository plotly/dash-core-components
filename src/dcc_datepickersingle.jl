...
function dcc_datepickersingle(; kwargs...)
        available_props = Symbol[:id, :calendar_orientation, :className, :clearable, :date, :day_size, :disabled, :display_format, :first_day_of_week, :initial_visible_month, :is_RTL, :loading_state, :max_date_allowed, :min_date_allowed, :month_format, :number_of_months_shown, :persisted_props, :persistence, :persistence_type, :placeholder, :reopen_calendar_on_clear, :show_outside_days, :stay_open_on_select, :style, :with_full_screen_portal, :with_portal]
        wild_props = Symbol[]
