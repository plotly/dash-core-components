...
function dcc_upload(; kwargs...)
        available_props = Symbol[:children, :id, :accept, :className, :className_active, :className_disabled, :className_reject, :contents, :disable_click, :disabled, :filename, :last_modified, :loading_state, :max_size, :min_size, :multiple, :style, :style_active, :style_disabled, :style_reject]
        wild_props = Symbol[]
