...
function dcc_confirmdialogprovider(; kwargs...)
        available_props = Symbol[:children, :id, :cancel_n_clicks, :cancel_n_clicks_timestamp, :displayed, :loading_state, :message, :submit_n_clicks, :submit_n_clicks_timestamp]
        wild_props = Symbol[]
